        ...
        .then(data => {
            ...
            if (usuarioEncontrado) {
                ...
                const userSession = {
                    ...
                    cargo: usuarioEncontrado.CARGO || 'Sin cargo asignado',
                ...
                if (usuarioEncontrado.SEDE === 'ALL') {
                    ...
                    // Guardar datos en sessionStorage en lugar de localStorage
    ...
    function showSedeModal(userData) {
        ...
        sedeButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                // Actualizar sessionStorage con la sede seleccionada
